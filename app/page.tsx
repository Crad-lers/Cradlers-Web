        ...
        <header className="bg-white shadow-md fixed w-full top-0 z-50">
          <nav className="max-w-6xl mx-auto flex justify-between items-center py-4 px-6">
            <div className="flex items-center space-x-2">
              <img src="/images/cradlers-high-resolution-logo.png" alt="Cradlers Logo" className="w-10 h-10" />
              <span className="text-2xl font-bold text-[#30D5C8]">Cradlers</span>
            </div>
            <ul className="hidden md:flex space-x-8 text-gay-700">
            ...
            <a href="#" className="hidden md:inline-block bg-[#28B7A6] hover:bg-[#1F97 86] text-white py-2 px-6 rounded-lg shadow-lg transition">
              Buy Now
            </a>
          </nav>
        </header>
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-6 bg-[#E0F7F5] rounded-lg shadow-md">
                <img src="/icons/intelligent-motion.svg" alt="Intelligent Motion" className="mx-auto mb-4" />
                <h3 className="text-xl font-semibold mb-2">Intelligent Motion</h3>
                <p>Adapts to your baby's sleep patterns for a peaceful nap.</p>
              </div>
              <div className="text-center p-6 bg-[#E0F7F5] rounded-lg shadow-md">
                <img src="/icons/safety-certified.svg" alt="Safety Certified" className="mx-auto mb-4" />
                <h3 className="text-xl font-semibold mb-2">Safety Certified</h3>
                <p>Built with safety in mind, so you can rest easy.</p>
              </div>
              <div className="text-center p-6 bg-[#E0F7F5] rounded-lg shadow-md">
                <img src="/icons/mobile-app.svg" alt="Mobile App Control" className="mx-auto mb-4" />
